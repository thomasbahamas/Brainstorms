...
export const MODULE_REGISTRY: AppModule[] = [
  ...
  },
  {
    ...
    name: "Content Engine",
    shortName: "Content",
    description: "Video ideas, narrative triggers, content pipeline",
    icon: Video,
  ...
  },
  {
    ...
    name: "Goals & OKRs",
    shortName: "Goals",
    description: "Track goals with key results and progress",
    icon: Target,
  ...
  },
  {
    ...
    name: "Habit Tracker",
    shortName: "Habits",
    description: "Daily habits with streak calendars",
    icon: Flame,
  ...
  },
  {
    ...
    name: "Daily Journal",
    shortName: "Journal",
    description: "Reflect, capture wins, plan tomorrow",
    icon: BookOpen,
  ...
  },
  {
    ...
    name: "Treasury",
    shortName: "Finance",
    description: "Budget, income, expenses, revenue trends",
    icon: DollarSign,
    gradient: "from-amber-500 to-yellow-500",
    href: "/finance",
    category: "personal",
